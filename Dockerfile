...
# libgl1 là thư viện đồ họa cần thiết cho OpenCV. tesseract-ocr-vie là gói ngôn ngữ tiếng Việt.
RUN apt-get update && apt-get install -y poppler-utils tesseract-ocr tesseract-ocr-vie libgl1
